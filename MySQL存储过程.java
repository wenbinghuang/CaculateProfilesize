...
/*
 ...
 create procedure simpleproc(IN in_name varchar(50),OUT result1 varchar(150))
...
/*
    建立数据库
    creat database yin_hang character set utf8 collate utf8_general_ci;
 use yin_hang;
